...
from lesson_28.hw_28.src.models.car_model import Car
from lesson_28.hw_28.src.pages.base_page import BasePage
from lesson_28.hw_28.src.custom_expected_conditions import CarToBeAddedToGarage, CarsNumberToBe
...
class GaragePage(BasePage):
    ...
    def wait_button_add_car(self, wait_time: int = 5):
        WebDriverWait(self.driver, wait_time).until(EC.text_to_be_present_in_element(self.ADD_CAR_BTN, "Add car"))
        return True
    ...
    def assert_that_user_registered(self):
        pass
