...
message = greet("Vika", "Feshch")
print(message)
print("-" * 100)
############################################################
# any(), all()

print(all([True, True, True]))  # return True
print(all([True, True, False]))  # return False


print(any([True, True, False]))  # return False
print(any([False, False, False]))  # return True

api_response = [
    {"username": "Vika", "email": "email@test.com", "is_active": True},
...
#############################################################
users = [
    {"username": "Vika", "email": "vika@test.com"},
...
print("-" * 100)
report2 = create_report("Project update report", "Summary", "Milestones", author="Vika F.", format="PDF", version=1.0)
print("-" * 100)
