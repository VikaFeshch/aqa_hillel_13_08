...
#################################################################
account1 = BankAccount(owner='Vika', balance=5000)
print(account1)
...
#################################################################
account1 = BankAccount(owner='Vika', balance=5000)
account2 = BankAccount(owner='Vero', balance=2000)
...
#################################################################
# ==
account1 = BankAccount(owner='Vika', balance=10000)
print(id(account1))
account2 = BankAccount(owner='Vika', balance=15000)
print(id(account2))
